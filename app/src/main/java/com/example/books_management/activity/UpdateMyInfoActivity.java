    ...
    private void setView() {
        ...
        btn_user_birth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(UpdateMyInfoActivity.this,listener,calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showAlertDialog() {
        ...
        builder.setPositiveButton("保存", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                updateUser(id);
                Toast.makeText(UpdateMyInfoActivity.this, "保存成功!", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
...
//        } else {
            ...
            if(user.getMobile().length()!=11){
                Toast.makeText(UpdateMyInfoActivity.this,"请输入正确的手机号！", Toast.LENGTH_SHORT).show();
            }else{
                ...
                contentValues.clear();
                Toast.makeText(UpdateMyInfoActivity.this, "修改成功！", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent();
                intent.putExtra("id", id);
