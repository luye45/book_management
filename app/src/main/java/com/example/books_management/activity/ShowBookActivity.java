        ...
        switch (requestCode){
            case 1:
                    if (resultCode == RESULT_OK){
                        book = queryBook(data.getStringExtra("id"));
                        this.book = book;
                        showData();
...
//            my_title_edit.setText("");
//            my_title_edit.setEnabled(false);
//        }
    }
    ...
    private void setView() {
        ...
        my_title_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShowBookActivity.this, UpdateBookActivity.class);
